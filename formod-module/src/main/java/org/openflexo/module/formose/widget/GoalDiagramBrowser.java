...
public class GoalDiagramBrowser extends FIBBrowserView<FMLRTVirtualModelInstance> {

	private static final Resource BROWSER_FIB = ResourceLocator.locateResource("Fib/GoalDiagramBrowser.fib");

	private FIBBrowser browser;

	public GoalDiagramBrowser(final FlexoController controller) {
		super(null, controller, BROWSER_FIB, controller.getModuleLocales());
		getFIBController().setBrowser(this);
	}

	@Override
	public GoalDiagramBrowserFIBController getFIBController() {
		return (GoalDiagramBrowserFIBController) super.getFIBController();
	}
	...
	private VirtualModel sysMLKaosViewpoint;

	public VirtualModel getSysMLKaosViewPoint() {
	...
	public static class GoalDiagramBrowserFIBController extends FMSFIBController {
		protected GoalDiagramBrowser browser;

		private String filteredName = null;
		private boolean isFiltered = false;
		private final List<FlexoConceptInstance> matchingValues;

		public GoalDiagramBrowserFIBController(FIBComponent component) {
		...
		protected void setBrowser(GoalDiagramBrowser browser) {
