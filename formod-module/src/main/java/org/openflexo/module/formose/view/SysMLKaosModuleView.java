...
/**
 * Main view for SysML/KAOS perspective
 */
@SuppressWarnings("serial")
public class SysMLKaosModuleView extends FIBModuleView<FormoseProjectNature> {

	public static Resource SYSML_KAOS_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/SysMLKaosMainPanel.fib");

	private final FlexoPerspective perspective;

	public SysMLKaosModuleView(FormoseProjectNature nature, FlexoController controller, FlexoPerspective perspective) {
		super(nature, controller, SYSML_KAOS_MODULE_VIEW_FIB, controller.getModule().getLocales());
	...
	public static class SysMLKaosModuleViewFIBController extends FMSFIBController {
		public SysMLKaosModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory) {
			super(component, viewFactory);
		}

		public SysMLKaosModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory, FlexoController controller) {
			super(component, viewFactory, controller);
		}

		public ImageIcon getProjectIcon() {
			return IconFactory.getImageIcon(FMSIconLibrary.FMS_BIG_ICON, FMSIconLibrary.SYSML_BIG_MARKER);
		}

		public ImageIcon getSysMLElementMappingIcon() {
			return IconFactory.getImageIcon(FMSIconLibrary.ELEMENT_BIG_ICON, FMSIconLibrary.SYSML_BIG_MARKER);
		}
