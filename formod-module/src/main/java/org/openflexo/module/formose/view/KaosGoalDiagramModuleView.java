...
public class KaosGoalDiagramModuleView extends FMLControlledDiagramModuleView {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(KaosGoalDiagramModuleView.class.getPackage().getName());

	private DGListener dgListener;
	private DSListener dsListener;

	public KaosGoalDiagramModuleView(FMLControlledDiagramEditor editor, SysMLKaosPerspective perspective) {
		super(editor, perspective);
		dgListener = new DGListener(perspective.getGoalDiagramBrowser().getFIBBrowserWidget().getTechnologyComponent().getJTree());
		dsListener = new DSListener();
	}

	@Override
	public SysMLKaosPerspective getPerspective() {
		return (SysMLKaosPerspective) super.getPerspective();
	}

	@Override
	public String getInfoMessage() {
		return "SysML/KAOS modelling - CTRL-drag to draw edges - CTRL+SHIFT-drag to group nodes";
	}
