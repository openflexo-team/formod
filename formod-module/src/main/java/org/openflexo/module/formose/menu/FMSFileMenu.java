...
package org.openflexo.module.formose.menu;
...
/**
 * 'File' menu for Formose Prototype
 *
 * @author sylvain
 */
@SuppressWarnings("serial")
public class FMSFileMenu extends FileMenu {

	public FMSFileMenu(FMSController controller) {
		super(controller);
	}

	public FMSController getFMSController() {
		return (FMSController) getController();
	}
	...
	@Override
	public void quit() {
		if (getFMSController().getApplicationContext().getResourceManager().getUnsavedResources().size() == 0) {
			super.quit();
		}
		else if (getFMSController().reviewModifiedResources()) {
			super.quit();
		}
	...
	public class SaveModifiedAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
			getFMSController().reviewModifiedResources();
		}
	}
