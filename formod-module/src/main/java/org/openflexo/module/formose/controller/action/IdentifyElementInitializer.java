 ...
 * @author sylvain
 */
public class IdentifyElementInitializer extends ActionInitializer<IdentifyElement, FormoseProjectNature, FlexoObject> {
	...
	@Override
	protected FlexoActionRunnable<IdentifyElement, FormoseProjectNature, FlexoObject> getDefaultInitializer() {
		return (e, action) -> {
	...
	@Override
	protected FlexoActionRunnable<IdentifyElement, FormoseProjectNature, FlexoObject> getDefaultFinalizer() {
		return (e, action) -> {
