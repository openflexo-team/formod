...
/**
 * Main view for B perspective
 */
@SuppressWarnings("serial")
public class BModuleView extends FIBModuleView<FormoseProjectNature> {

	public static Resource B_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/BMainPanel.fib");

	private final FlexoPerspective perspective;

	public BModuleView(FormoseProjectNature nature, FlexoController controller, FlexoPerspective perspective) {
		super(nature, controller, B_MODULE_VIEW_FIB, controller.getModule().getLocales());
	...
	public static class BModuleViewFIBController extends FMSFIBController {
		public BModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory) {
			super(component, viewFactory);
		}

		public BModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory, FlexoController controller) {
			super(component, viewFactory, controller);
		}

		public ImageIcon getProjectIcon() {
			return IconFactory.getImageIcon(FMSIconLibrary.FMS_BIG_ICON, FMSIconLibrary.B_BIG_MARKER);
		}

		public ImageIcon getDomainModelElementMappingIcon() {
			return IconFactory.getImageIcon(FMSIconLibrary.ELEMENT_BIG_ICON, FMSIconLibrary.B_BIG_MARKER);
		}
