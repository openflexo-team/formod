...
/**
 * Main view for Formose
 */
@SuppressWarnings("serial")
public class FormoseProjectNatureModuleView extends FIBModuleView<FormoseProjectNature> {

	public static Resource FMS_PROJECT_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/FMSProjectNaturePanel.fib");

	private final FlexoPerspective perspective;

	public FormoseProjectNatureModuleView(FormoseProjectNature nature, FlexoController controller, FlexoPerspective perspective) {
	...
	public void setDataObject(Object dataObject) {
		...
		if (dataObject instanceof FormoseProjectNature && getFIBController() != null) {
			...
			System.out.println("formoseView=" + ((FormoseProjectNature) dataObject).getFormoseInstance().getAccessedVirtualModelInstance());
	...
	public static class FormoseProjectNatureModuleViewFIBController extends FMSFIBController {
		public FormoseProjectNatureModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory) {
		...
		public ImageIcon getProjectIcon() {
			return FMSIconLibrary.FMS_BIG_ICON;
		}
