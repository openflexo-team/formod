 ...
 * 
 */
public abstract class BMemberNode<N extends Node, T extends BMember> extends BObjectNode<N, T> {

	public BMemberNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BMemberNode(T concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BMemberNode<N, T> deserialize() {
		return this;
	}
