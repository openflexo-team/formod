...
/**
 * A role which allow to reference a {@link AtelierBComponent}
 * 
 * @author sylvain
 *
 */
@ModelEntity
@ImplementationClass(AtelierBComponentRole.AtelierBComponentRoleImpl.class)
@XMLElement
@FML("AtelierBComponentRole")
public interface AtelierBComponentRole extends FlexoRole<AtelierBComponent> {

	public static abstract class AtelierBComponentRoleImpl extends FlexoRoleImpl<AtelierBComponent> implements AtelierBComponentRole {
