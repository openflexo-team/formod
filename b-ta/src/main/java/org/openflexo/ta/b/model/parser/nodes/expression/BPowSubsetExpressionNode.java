 ...
 * 
 */
public class BPowSubsetExpressionNode extends BExpressionNode<APowSubsetExpression, BPowSubsetExpression> {

	public BPowSubsetExpressionNode(APowSubsetExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BPowSubsetExpressionNode(BPowSubsetExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BPowSubsetExpression buildModelObjectFromAST(APowSubsetExpression astNode) {
		getAnalyser().push(this);
		BPowSubsetExpression returned = getModelFactory().makeExpression(BPowSubsetExpression.class, getAnalyser().getBComponent());
