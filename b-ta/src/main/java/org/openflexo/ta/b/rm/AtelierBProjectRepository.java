...
/**
 * AtelierB project resource repository<br>
 * 
 * A repository which references some {@link AtelierBProject}
 * 
 * @author sylvain
 * 
 */
@ModelEntity
public interface AtelierBProjectRepository<I>
		extends TechnologyAdapterResourceRepository<AtelierBProjectResource, BTechnologyAdapter, AtelierBProject, I> {
