 ...
 * 
 */
public class BEqualPredicateNode extends BBinaryExpressionPredicateNode<AEqualPredicate, BEqualPredicate> {

	public BEqualPredicateNode(AEqualPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BEqualPredicateNode(BEqualPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BEqualPredicate buildModelObjectFromAST(AEqualPredicate astNode) {
		getAnalyser().push(this);
		BEqualPredicate returned = getModelFactory().makePredicate(BEqualPredicate.class, getAnalyser().getBComponent());
