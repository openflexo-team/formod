 ...
 * 
 */
public class BMultOrCartExpressionNode extends BBinaryExpressionNode<AMultOrCartExpression, BMultOrCartExpression> {

	public BMultOrCartExpressionNode(AMultOrCartExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BMultOrCartExpressionNode(BMultOrCartExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BMultOrCartExpression buildModelObjectFromAST(AMultOrCartExpression astNode) {
		getAnalyser().push(this);
		BMultOrCartExpression returned = getModelFactory().makeExpression(BMultOrCartExpression.class, getAnalyser().getBComponent());
