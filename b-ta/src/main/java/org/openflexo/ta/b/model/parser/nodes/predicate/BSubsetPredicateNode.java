 ...
 * 
 */
public class BSubsetPredicateNode extends BBinaryExpressionPredicateNode<ASubsetPredicate, BSubsetPredicate> {

	public BSubsetPredicateNode(ASubsetPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BSubsetPredicateNode(BSubsetPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BSubsetPredicate buildModelObjectFromAST(ASubsetPredicate astNode) {
		getAnalyser().push(this);
		BSubsetPredicate returned = getModelFactory().makePredicate(BSubsetPredicate.class, getAnalyser().getBComponent());
