 ...
 * 
 */
public abstract class BOperationNode<N extends Node, T extends BOperation> extends BObjectNode<N, T> {

	public BOperationNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BOperationNode(T concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BOperationNode<N, T> deserialize() {
		return this;
	}
