 ...
 * 
 */
public abstract class BBinaryExpressionPredicateNode<N extends Node, T extends BBinaryExpressionPredicate> extends BPredicateNode<N, T> {

	public BBinaryExpressionPredicateNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BBinaryExpressionPredicateNode(T concept, BSemanticsAnalyzer analyser) {
