 ...
 * 
 */
public class BPartialSurjectionExpressionNode extends BBinaryExpressionNode<APartialSurjectionExpression, BPartialSurjectionExpression> {

	public BPartialSurjectionExpressionNode(APartialSurjectionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BPartialSurjectionExpressionNode(BPartialSurjectionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BPartialSurjectionExpression buildModelObjectFromAST(APartialSurjectionExpression astNode) {
		getAnalyser().push(this);
		BPartialSurjectionExpression returned = getModelFactory().makeExpression(BPartialSurjectionExpression.class, getAnalyser().getBComponent());
