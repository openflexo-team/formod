 ...
 * 
 */
public class BGreaterPredicateNode extends BBinaryExpressionPredicateNode<AGreaterPredicate, BGreaterPredicate> {

	public BGreaterPredicateNode(AGreaterPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BGreaterPredicateNode(BGreaterPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BGreaterPredicate buildModelObjectFromAST(AGreaterPredicate astNode) {
		getAnalyser().push(this);
		BGreaterPredicate returned = getModelFactory().makePredicate(BGreaterPredicate.class, getAnalyser().getBComponent());
