 ...
 * 
 */
public class BLessPredicateNode extends BBinaryExpressionPredicateNode<ALessPredicate, BLessPredicate> {

	public BLessPredicateNode(ALessPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BLessPredicateNode(BLessPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BLessPredicate buildModelObjectFromAST(ALessPredicate astNode) {
		getAnalyser().push(this);
		BLessPredicate returned = getModelFactory().makePredicate(BLessPredicate.class, getAnalyser().getBComponent());
