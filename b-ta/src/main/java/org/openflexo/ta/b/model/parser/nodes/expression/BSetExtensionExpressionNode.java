 ...
 * 
 */
public class BSetExtensionExpressionNode extends BExpressionNode<ASetExtensionExpression, BSetExtensionExpression> {

	public BSetExtensionExpressionNode(ASetExtensionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BSetExtensionExpressionNode(BSetExtensionExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BSetExtensionExpression buildModelObjectFromAST(ASetExtensionExpression astNode) {
		getAnalyser().push(this);
		BSetExtensionExpression returned = getModelFactory().makeExpression(BSetExtensionExpression.class, getAnalyser().getBComponent());
		for (PExpression expression : astNode.getExpressions()) {
