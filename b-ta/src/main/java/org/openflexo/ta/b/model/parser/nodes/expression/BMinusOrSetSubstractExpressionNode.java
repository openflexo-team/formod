 ...
 * 
 */
public class BMinusOrSetSubstractExpressionNode
		extends BBinaryExpressionNode<AMinusOrSetSubtractExpression, BMinusOrSetSubstractExpression> {

	public BMinusOrSetSubstractExpressionNode(AMinusOrSetSubtractExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BMinusOrSetSubstractExpressionNode(BMinusOrSetSubstractExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BMinusOrSetSubstractExpression buildModelObjectFromAST(AMinusOrSetSubtractExpression astNode) {
		getAnalyser().push(this);
		BMinusOrSetSubstractExpression returned = getModelFactory().makeExpression(BMinusOrSetSubstractExpression.class,
