 ...
 * 
 */
public class BPreconditionSubstitutionNode extends BSubstitutionNode<APreconditionSubstitution, BPreconditionSubstitution> {

	public BPreconditionSubstitutionNode(APreconditionSubstitution astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BPreconditionSubstitutionNode(BPreconditionSubstitution concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BPreconditionSubstitution buildModelObjectFromAST(APreconditionSubstitution astNode) {
		getAnalyser().push(this);
		BPreconditionSubstitution returned = getModelFactory().makeSubstitution(BPreconditionSubstitution.class,
		...
		BSubstitutionNode<?, ?> substitutionNode = getSubstitutionFactory().makeSubstitutionNode(astNode.getSubstitution());
		returned.setSubstitution(substitutionNode.getModelObject());
