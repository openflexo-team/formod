...
package org.openflexo.ta.b.fml.binding;
...
/**
 * Defines B-specific types binding path element strategy<br>
 * 
 ...
 *
 */
public final class BBindingFactory extends TechnologyAdapterBindingFactory {
	static final Logger logger = Logger.getLogger(BBindingFactory.class.getPackage().getName());

	public BBindingFactory() {
		super();
	}
