 ...
 * 
 */
public class BIdentifierExpressionNode extends BExpressionNode<AIdentifierExpression, BIdentifierExpression> {

	public BIdentifierExpressionNode(AIdentifierExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BIdentifierExpressionNode(BIdentifierExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BIdentifierExpression buildModelObjectFromAST(AIdentifierExpression astNode) {
		getAnalyser().push(this);
		BIdentifierExpression returned = getModelFactory().makeExpression(BIdentifierExpression.class, getAnalyser().getBComponent());
		returned.setIdentifier(getText(astNode.getIdentifier()));
		getAnalyser().pop();
		return returned;
	}
