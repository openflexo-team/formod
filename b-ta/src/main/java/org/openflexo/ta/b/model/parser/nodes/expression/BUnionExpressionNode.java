 ...
 * 
 */
public class BUnionExpressionNode extends BBinaryExpressionNode<AUnionExpression, BUnionExpression> {

	public BUnionExpressionNode(AUnionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BUnionExpressionNode(BUnionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BUnionExpression buildModelObjectFromAST(AUnionExpression astNode) {
		getAnalyser().push(this);
		BUnionExpression returned = getModelFactory().makeExpression(BUnionExpression.class, getAnalyser().getBComponent());
