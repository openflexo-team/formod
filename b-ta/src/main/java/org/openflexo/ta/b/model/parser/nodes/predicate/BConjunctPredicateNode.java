 ...
 * 
 */
public class BConjunctPredicateNode extends BBinaryPredicatePredicateNode<AConjunctPredicate, BConjunctPredicate> {

	public BConjunctPredicateNode(AConjunctPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BConjunctPredicateNode(BConjunctPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BConjunctPredicate buildModelObjectFromAST(AConjunctPredicate astNode) {
		getAnalyser().push(this);
		BConjunctPredicate returned = getModelFactory().makePredicate(BConjunctPredicate.class, getAnalyser().getBComponent());
