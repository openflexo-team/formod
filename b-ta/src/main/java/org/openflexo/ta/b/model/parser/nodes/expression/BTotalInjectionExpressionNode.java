 ...
 * 
 */
public class BTotalInjectionExpressionNode extends BBinaryExpressionNode<ATotalInjectionExpression, BTotalInjectionExpression> {

	public BTotalInjectionExpressionNode(ATotalInjectionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BTotalInjectionExpressionNode(BTotalInjectionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BTotalInjectionExpression buildModelObjectFromAST(ATotalInjectionExpression astNode) {
		getAnalyser().push(this);
		BTotalInjectionExpression returned = getModelFactory().makeExpression(BTotalInjectionExpression.class,
