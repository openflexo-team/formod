 ...
 * 
 */
public class BPartialInjectionExpressionNode extends BBinaryExpressionNode<APartialInjectionExpression, BPartialInjectionExpression> {

	public BPartialInjectionExpressionNode(APartialInjectionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BPartialInjectionExpressionNode(BPartialInjectionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BPartialInjectionExpression buildModelObjectFromAST(APartialInjectionExpression astNode) {
		getAnalyser().push(this);
		BPartialInjectionExpression returned = getModelFactory().makeExpression(BPartialInjectionExpression.class, getAnalyser().getBComponent());
