 ...
 * 
 */
public class BTotalSurjectionExpressionNode extends BBinaryExpressionNode<ATotalSurjectionExpression, BTotalSurjectionExpression> {

	public BTotalSurjectionExpressionNode(ATotalSurjectionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BTotalSurjectionExpressionNode(BTotalSurjectionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BTotalSurjectionExpression buildModelObjectFromAST(ATotalSurjectionExpression astNode) {
		getAnalyser().push(this);
		BTotalSurjectionExpression returned = getModelFactory().makeExpression(BTotalSurjectionExpression.class, getAnalyser().getBComponent());
