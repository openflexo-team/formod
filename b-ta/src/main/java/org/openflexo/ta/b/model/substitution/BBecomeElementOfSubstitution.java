...
@XMLElement
public interface BBecomeElementOfSubstitution extends BSubstitution {
	...
	@XMLElement(context = "Set_")
	public BExpression getSet();

	@Setter(SET_KEY)
	public void setSet(BExpression anExpression);
