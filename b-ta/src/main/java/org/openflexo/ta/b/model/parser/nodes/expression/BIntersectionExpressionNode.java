 ...
 * 
 */
public class BIntersectionExpressionNode extends BBinaryExpressionNode<AIntersectionExpression, BIntersectionExpression> {

	public BIntersectionExpressionNode(AIntersectionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BIntersectionExpressionNode(BIntersectionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BIntersectionExpression buildModelObjectFromAST(AIntersectionExpression astNode) {
		getAnalyser().push(this);
		BIntersectionExpression returned = getModelFactory().makeExpression(BIntersectionExpression.class, getAnalyser().getBComponent());
