 ...
 * 
 */
public abstract class BPredicateNode<N extends Node, T extends BPredicate> extends BObjectNode<N, T> {

	public BPredicateNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BPredicateNode(T concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BPredicateNode<N, T> deserialize() {
		return this;
	}
