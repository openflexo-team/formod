 ...
 * 
 */
public class BUnaryMinusExpressionNode extends BExpressionNode<AUnaryMinusExpression, BUnaryMinusExpression> {

	public BUnaryMinusExpressionNode(AUnaryMinusExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BUnaryMinusExpressionNode(BUnaryMinusExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BUnaryMinusExpression buildModelObjectFromAST(AUnaryMinusExpression astNode) {
		getAnalyser().push(this);
		BUnaryMinusExpression returned = getModelFactory().makeExpression(BUnaryMinusExpression.class, getAnalyser().getBComponent());
