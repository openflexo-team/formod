 ...
 * 
 */
public class BGreaterEqualPredicateNode extends BBinaryExpressionPredicateNode<AGreaterEqualPredicate, BGreaterEqualPredicate> {

	public BGreaterEqualPredicateNode(AGreaterEqualPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BGreaterEqualPredicateNode(BGreaterEqualPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BGreaterEqualPredicate buildModelObjectFromAST(AGreaterEqualPredicate astNode) {
		getAnalyser().push(this);
		BGreaterEqualPredicate returned = getModelFactory().makePredicate(BGreaterEqualPredicate.class, getAnalyser().getBComponent());
