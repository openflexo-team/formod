 ...
 * 
 */
public class BBlockSubstitutionNode extends BSubstitutionNode<ABlockSubstitution, BBlockSubstitution> {

	public BBlockSubstitutionNode(ABlockSubstitution astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BBlockSubstitutionNode(BBlockSubstitution concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BBlockSubstitution buildModelObjectFromAST(ABlockSubstitution astNode) {
		getAnalyser().push(this);
		BBlockSubstitution returned = getModelFactory().makeSubstitution(BBlockSubstitution.class, getAnalyser().getBComponent());
