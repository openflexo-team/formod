 ...
 * 
 */
public class BSystemNode extends BComponentNode<AAbstractMachineParseUnit, BSystem> {

	public BSystemNode(AAbstractMachineParseUnit astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BSystemNode(BSystem concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BSystem buildModelObjectFromAST(AAbstractMachineParseUnit astNode) {
		BSystem returned = getModelFactory().makeSystem();
