 ...
 * 
 */
public class BRelationsExpressionNode extends BBinaryExpressionNode<ARelationsExpression, BRelationsExpression> {

	public BRelationsExpressionNode(ARelationsExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BRelationsExpressionNode(BRelationsExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BRelationsExpression buildModelObjectFromAST(ARelationsExpression astNode) {
		getAnalyser().push(this);
		BRelationsExpression returned = getModelFactory().makeExpression(BRelationsExpression.class, getAnalyser().getBComponent());
