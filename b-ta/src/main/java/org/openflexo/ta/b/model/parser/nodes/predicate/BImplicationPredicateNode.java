 ...
 * 
 */
public class BImplicationPredicateNode extends BBinaryPredicatePredicateNode<AImplicationPredicate, BImplicationPredicate> {

	public BImplicationPredicateNode(AImplicationPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BImplicationPredicateNode(BImplicationPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BImplicationPredicate buildModelObjectFromAST(AImplicationPredicate astNode) {
		getAnalyser().push(this);
		BImplicationPredicate returned = getModelFactory().makePredicate(BImplicationPredicate.class, getAnalyser().getBComponent());
