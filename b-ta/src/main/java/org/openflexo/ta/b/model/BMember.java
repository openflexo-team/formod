...
/**
 * Abstract representation for elements of ABSTRACT_CONSTANTS, CONCRETE_CONSTANTS, ABSTRACT_VARIABLES, CONCRETE_VARIABLES
 * 
 * @author sylvain
 *
 */
...
public interface BMember extends BNamedObject, InnerBComponent {

	/**
	 * Default base implementation for {@link BMember}
	 * 
	 * @author sylvain
	 *
	 */
	public static abstract class BMemberImpl extends BObjectImpl implements BMember {
