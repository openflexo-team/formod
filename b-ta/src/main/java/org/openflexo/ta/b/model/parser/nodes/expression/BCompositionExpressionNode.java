 ...
 * 
 */
public class BCompositionExpressionNode extends BBinaryExpressionNode<ACompositionExpression, BCompositionExpression> {

	public BCompositionExpressionNode(ACompositionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BCompositionExpressionNode(BCompositionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BCompositionExpression buildModelObjectFromAST(ACompositionExpression astNode) {
		getAnalyser().push(this);
		BCompositionExpression returned = getModelFactory().makeExpression(BCompositionExpression.class, getAnalyser().getBComponent());
