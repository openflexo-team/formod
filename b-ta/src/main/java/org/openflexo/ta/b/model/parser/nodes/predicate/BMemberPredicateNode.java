 ...
 * 
 */
public class BMemberPredicateNode extends BBinaryExpressionPredicateNode<AMemberPredicate, BMemberPredicate> {

	public BMemberPredicateNode(AMemberPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BMemberPredicateNode(BMemberPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BMemberPredicate buildModelObjectFromAST(AMemberPredicate astNode) {
		getAnalyser().push(this);
		BMemberPredicate returned = getModelFactory().makePredicate(BMemberPredicate.class, getAnalyser().getBComponent());
