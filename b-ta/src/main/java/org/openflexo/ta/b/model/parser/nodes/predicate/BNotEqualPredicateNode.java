 ...
 * 
 */
public class BNotEqualPredicateNode extends BBinaryExpressionPredicateNode<ANotEqualPredicate, BNotEqualPredicate> {

	public BNotEqualPredicateNode(ANotEqualPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BNotEqualPredicateNode(BNotEqualPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BNotEqualPredicate buildModelObjectFromAST(ANotEqualPredicate astNode) {
		getAnalyser().push(this);
		BNotEqualPredicate returned = getModelFactory().makePredicate(BNotEqualPredicate.class, getAnalyser().getBComponent());
