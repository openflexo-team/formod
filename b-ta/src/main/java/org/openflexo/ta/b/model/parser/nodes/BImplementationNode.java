 ...
 * 
 */
public class BImplementationNode extends BComponentNode<AImplementationMachineParseUnit, BImplementation> {

	public BImplementationNode(AImplementationMachineParseUnit astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BImplementationNode(BImplementation concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BImplementation buildModelObjectFromAST(AImplementationMachineParseUnit astNode) {
		BImplementation returned = getModelFactory().makeImplementation();
