 ...
 * 
 */
public class BAnySubstitutionNode extends BSubstitutionNode<AAnySubstitution, BAnySubstitution> {

	public BAnySubstitutionNode(AAnySubstitution astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BAnySubstitutionNode(BAnySubstitution concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BAnySubstitution buildModelObjectFromAST(AAnySubstitution astNode) {
		getAnalyser().push(this);
		BAnySubstitution returned = getModelFactory().makeSubstitution(BAnySubstitution.class, getAnalyser().getBComponent());
		BPredicateNode<?, ?> whereNode = getPredicateFactory().makePredicateNode(astNode.getWhere());
		returned.setWhere(whereNode.getModelObject());
