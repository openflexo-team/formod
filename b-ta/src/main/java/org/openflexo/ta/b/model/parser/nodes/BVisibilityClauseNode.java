...
import org.openflexo.ta.b.model.BVisibilityClause;
 ...
 * 
 */
public abstract class BVisibilityClauseNode<N extends Node, T extends BVisibilityClause> extends BObjectNode<N, T> {

	public BVisibilityClauseNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BVisibilityClauseNode(T concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BVisibilityClauseNode<N, T> deserialize() {
		return this;
	}
