 ...
 * 
 */
public class BSkipSubstitutionNode extends BSubstitutionNode<ASkipSubstitution, BSkipSubstitution> {

	public BSkipSubstitutionNode(ASkipSubstitution astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BSkipSubstitutionNode(BSkipSubstitution concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BSkipSubstitution buildModelObjectFromAST(ASkipSubstitution astNode) {
		getAnalyser().push(this);
		BSkipSubstitution returned = getModelFactory().makeSubstitution(BSkipSubstitution.class, getAnalyser().getBComponent());
		getAnalyser().pop();
		return returned;
	}
