 ...
 * 
 */
public class BIdentityExpressionNode extends BExpressionNode<AIdentityExpression, BIdentityExpression> {

	public BIdentityExpressionNode(AIdentityExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BIdentityExpressionNode(BIdentityExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BIdentityExpression buildModelObjectFromAST(AIdentityExpression astNode) {
		getAnalyser().push(this);
		BIdentityExpression returned = getModelFactory().makeExpression(BIdentityExpression.class, getAnalyser().getBComponent());
