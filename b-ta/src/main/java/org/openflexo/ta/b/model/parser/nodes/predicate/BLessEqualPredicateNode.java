 ...
 * 
 */
public class BLessEqualPredicateNode extends BBinaryExpressionPredicateNode<ALessEqualPredicate, BLessEqualPredicate> {

	public BLessEqualPredicateNode(ALessEqualPredicate astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BLessEqualPredicateNode(BLessEqualPredicate concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BLessEqualPredicate buildModelObjectFromAST(ALessEqualPredicate astNode) {
		getAnalyser().push(this);
		BLessEqualPredicate returned = getModelFactory().makePredicate(BLessEqualPredicate.class, getAnalyser().getBComponent());
