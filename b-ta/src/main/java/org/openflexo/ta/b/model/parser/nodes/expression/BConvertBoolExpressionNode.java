 ...
 * 
 */
public class BConvertBoolExpressionNode extends BExpressionNode<AConvertBoolExpression, BConvertBoolExpression> {

	public BConvertBoolExpressionNode(AConvertBoolExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BConvertBoolExpressionNode(BConvertBoolExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BConvertBoolExpression buildModelObjectFromAST(AConvertBoolExpression astNode) {
		getAnalyser().push(this);
		BConvertBoolExpression returned = getModelFactory().makeExpression(BConvertBoolExpression.class, getAnalyser().getBComponent());
