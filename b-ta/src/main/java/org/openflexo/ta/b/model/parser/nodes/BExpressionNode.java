 ...
 * 
 */
public abstract class BExpressionNode<N extends Node, T extends BExpression> extends BObjectNode<N, T> {

	public BExpressionNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BExpressionNode(T concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BExpressionNode<N, T> deserialize() {
		return this;
	}
