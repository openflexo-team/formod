 ...
 * 
 */
public class BPartialFunctionExpressionNode extends BBinaryExpressionNode<APartialFunctionExpression, BPartialFunctionExpression> {

	public BPartialFunctionExpressionNode(APartialFunctionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BPartialFunctionExpressionNode(BPartialFunctionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BPartialFunctionExpression buildModelObjectFromAST(APartialFunctionExpression astNode) {
		getAnalyser().push(this);
		BPartialFunctionExpression returned = getModelFactory().makeExpression(BPartialFunctionExpression.class,
