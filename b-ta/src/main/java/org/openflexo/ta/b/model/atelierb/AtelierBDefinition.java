...
/**
 * Some informations on AtelierB version of AtelierB project
 * 
 * @author sylvain
 *
 */
@ModelEntity
@XMLElement(xmlTag = "atelierb")
@ImplementationClass(AtelierBProjectObjectImpl.class)
public interface AtelierBDefinition extends AtelierBProjectObject {
