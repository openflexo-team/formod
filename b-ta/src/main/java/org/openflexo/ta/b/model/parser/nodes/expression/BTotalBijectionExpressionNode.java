 ...
 * 
 */
public class BTotalBijectionExpressionNode extends BBinaryExpressionNode<ATotalBijectionExpression, BTotalBijectionExpression> {

	public BTotalBijectionExpressionNode(ATotalBijectionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BTotalBijectionExpressionNode(BTotalBijectionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BTotalBijectionExpression buildModelObjectFromAST(ATotalBijectionExpression astNode) {
		getAnalyser().push(this);
		BTotalBijectionExpression returned = getModelFactory().makeExpression(BTotalBijectionExpression.class, getAnalyser().getBComponent());
