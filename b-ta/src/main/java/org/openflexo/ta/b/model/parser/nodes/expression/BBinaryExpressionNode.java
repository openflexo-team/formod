 ...
 * 
 */
public abstract class BBinaryExpressionNode<N extends Node, T extends BBinaryExpression> extends BExpressionNode<N, T> {

	public BBinaryExpressionNode(N astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BBinaryExpressionNode(T concept, BSemanticsAnalyzer analyser) {
