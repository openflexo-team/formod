...
@Imports({ @Import(BBinaryPredicatePredicate.class), @Import(BBinaryExpressionPredicate.class), @Import(BForAllPredicate.class) })
public interface BPredicate extends BObject, InnerBComponent {

	/**
	 * Default base implementation for {@link BPredicate}
	 * 
	 * @author sylvain
	 *
	 */
	public static abstract class BPredicateImpl extends BObjectImpl implements BPredicate {
		...
		public String getSerializationIdentifier() {
			// Cannot serialize id for predicate
			return null;
		}
	}
