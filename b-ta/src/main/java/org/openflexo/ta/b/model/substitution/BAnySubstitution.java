...
@XMLElement
public interface BAnySubstitution extends BSubstitution {
	 ...
	 * @return
	 */
	@Getter(value = WHERE_KEY)
	@XMLElement(context = "Predicate")
	public BPredicate getWhere();

	/**
	 * Sets WHERE predicate
	 * 
	 * @return
	 */
	@Setter(WHERE_KEY)
	public void setWhere(BPredicate aPredicate);
