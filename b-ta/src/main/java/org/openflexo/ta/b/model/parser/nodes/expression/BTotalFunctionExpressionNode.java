 ...
 * 
 */
public class BTotalFunctionExpressionNode extends BBinaryExpressionNode<ATotalFunctionExpression, BTotalFunctionExpression> {

	public BTotalFunctionExpressionNode(ATotalFunctionExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BTotalFunctionExpressionNode(BTotalFunctionExpression concept, BSemanticsAnalyzer analyser) {
	...
	@Override
	public BTotalFunctionExpression buildModelObjectFromAST(ATotalFunctionExpression astNode) {
		getAnalyser().push(this);
		BTotalFunctionExpression returned = getModelFactory().makeExpression(BTotalFunctionExpression.class, getAnalyser().getBComponent());
