 ...
 * 
 */
public class BDomainExpressionNode extends BExpressionNode<ADomainExpression, BDomainExpression> {

	public BDomainExpressionNode(ADomainExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BDomainExpressionNode(BDomainExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BDomainExpression buildModelObjectFromAST(ADomainExpression astNode) {
		getAnalyser().push(this);
		BDomainExpression returned = getModelFactory().makeExpression(BDomainExpression.class, getAnalyser().getBComponent());
