 ...
 * 
 */
public class BRangeExpressionNode extends BExpressionNode<ARangeExpression, BRangeExpression> {

	public BRangeExpressionNode(ARangeExpression astNode, BSemanticsAnalyzer analyser) {
		super(astNode, analyser);
	}

	public BRangeExpressionNode(BRangeExpression concept, BSemanticsAnalyzer analyser) {
		super(concept, analyser);
	}

	@Override
	public BRangeExpression buildModelObjectFromAST(ARangeExpression astNode) {
		getAnalyser().push(this);
		BRangeExpression returned = getModelFactory().makeExpression(BRangeExpression.class, getAnalyser().getBComponent());
