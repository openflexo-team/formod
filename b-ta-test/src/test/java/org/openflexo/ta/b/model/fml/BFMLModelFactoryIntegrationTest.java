...
package org.openflexo.ta.b.model.fml;
...
public class BFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(BFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(BTechnologyAdapter.class));
	}
	...
	@Test
	@TestOrder(2)
	public void checkBFMLTechnologyAdapter() {
		log("checkBFMLTechnologyAdapter()");

		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(BTechnologyAdapter.class));
	}
