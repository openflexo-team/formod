...
/**
 * Test instanciation of BModelFactory<br>
 * 
 */
@RunWith(OrderedRunner.class)
public class BModelFactoryTest {

	@SuppressWarnings("unused")
	private static final Logger LOGGER = FlexoLogger.getLogger(BModelFactoryTest.class.getPackage().getName());

	private static BModelFactory factory;

	@Test
	@TestOrder(1)
	public void instanciateFIBModelFactory() throws ModelDefinitionException {
		factory = new BModelFactory(null, null);
	}
